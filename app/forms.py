#To begin, let's define a user login form, which asks the user to enter a username and a password. 
# The form will also include a "remember me" check box, and a submit button
...
# a registration form, so that users can register themselves through a web form.
...
# The form is going to let users change their username, and also write something about 
# themselves, to be stored in the new about_me field
